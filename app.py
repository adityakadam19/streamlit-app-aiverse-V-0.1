...
def home():
    ...
    with logo_col1:
        st.image("coding.png", width=200)  # Replace "logo.png" with your logo file path
...
def ai_interview():
    ...
    while interview_in_progress and question_count < 5:  # Limit to a maximum of 5 questions
        ...
        # Omitted settings for API call...

        response = "Here the interview question generated by OpenAI API will be inserted."
    ...
    if not interview_in_progress and question_count > 0:
        ...
        review_feedback = "Here the interview feedback generated by OpenAI API will be inserted."
